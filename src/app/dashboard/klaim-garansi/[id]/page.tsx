...
// ============ TYPES ============
type ClaimStatus = "waiting" | "rejected";
...
function StatusBanner({ status }: { status: ClaimStatus }) {
  if (status === "waiting") {
    return (
      <div
        data-testid="status-banner-waiting"
        className="bg-primary text-secondary p-4 rounded-lg text-sm font-medium"
      >
...
export default function ClaimDetailPage() {
  ...
  // Get claim data based on ID, default to waiting state
