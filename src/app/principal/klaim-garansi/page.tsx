...
const MOCK_REQUESTS: ClaimRequest[] = Array.from({ length: 25 }, (_, index) => {
...
export default function PrincipalKlaimGaransiPage() {
    ...
    <div className="w-full flex flex-col gap-5 p-5 text-sm xl:text-base min-h-screen bg-background">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-text-secondary text-sm">
          Menampilkan keseluruhan permintaan klaim garansi ban yang diajukan oleh
          Customer
        </p>
      </div>
                    ...
                    >
                      ...
                      <td className="px-5 py-4 whitespace-nowrap">
                        <StatusBadge
                          ...
                          variant="adminVerification"
                          showIcon={false}
                        />
                      </td>
                      <td className="px-5 py-4 whitespace-nowrap">
                        <Link
                          href={`/principal/klaim-garansi/${request.id}`}
